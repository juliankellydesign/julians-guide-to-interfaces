...
| [Interface](interface/README.md) | Product framing and interaction design | Problems, interactions, interrogating the ask, conventions and novel elements earning their spot, action hierarchy, top and bottom placement, input sizing, input fidelity, repeated actions, corner rounding, shadows, conventions, perceived speed, empty and error states, personal taste as scaffolding, a musing on nesting buttons in inputs |
