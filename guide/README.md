...
- Interface principles keep shadows distinct from the containers that cast them; a shadow that would blend into its container is questioned rather than tuned.
