...
- Motion principles cover continuity, causality, responsiveness, accessibility, and morphing only between elements that do or mean the same thing. Load the timing and animation-scaffold methods only when exact durations or the 48-frame structure are needed.
